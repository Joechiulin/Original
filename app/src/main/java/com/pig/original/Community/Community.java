...
public class Community extends Fragment {
    ...
    private void showAllPosts() {
        if (Common.networkConnected(comactivity)) {
            ...
            if (friends == null || friends.isEmpty()) {
                ...
                rvcomFriends.setAdapter(new Community.SpotsRecyclerViewAdapter(comactivity, friends));
            }
        } else {
    ...
    private class SpotsRecyclerViewAdapter extends RecyclerView.Adapter<Community.SpotsRecyclerViewAdapter.MyViewHolder> {
        ...
        @NonNull
        @Override
        public Community.SpotsRecyclerViewAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            View itemView = layoutInflater.inflate(R.layout.communityitemview, parent, false);
            return new Community.SpotsRecyclerViewAdapter.MyViewHolder(itemView);
        }

        @Override
        public void onBindViewHolder(@NonNull Community.SpotsRecyclerViewAdapter.MyViewHolder myViewHolder, int position) {
